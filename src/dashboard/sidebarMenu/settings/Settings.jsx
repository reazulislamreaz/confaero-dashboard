    ...
    <div className=" mx-6 ">
      ...
      <div>
        ...
        <div onClick={() => navigate("/dashboard/settings/privacypolicy")} className="mt-8 cursor-pointer flex justify-between bg-[#F7F7F7] rounded items-center w-full h-[75px]">
          <p className="text-[18px] text-[#616161] ml-8 font-medium">Privacy Policy</p>
          <Link to="/dashboard/settings/privacypolicy" className="mr-8 text-[#616161] px-2 py-1 rounded cursor-pointer">
            <IoIosArrowForward />
          </Link>
        </div>
        <div onClick={() => navigate("/dashboard/settings/termcondition")} className="mt-8 flex justify-between cursor-pointer bg-[#F7F7F7] rounded items-center w-full h-[75px]">
          <p className="text-[18px] text-[#616161] ml-8 font-medium">Terms and Condition</p>
          <Link to="/dashboard/settings/termcondition" className="mr-8 text-[#616161] px-2 py-1 rounded cursor-pointer">
            <IoIosArrowForward />
          </Link>
        </div>
        <div onClick={() => navigate("/dashboard/settings/about")} className="mt-8 cursor-pointer flex justify-between bg-[#F7F7F7] rounded items-center w-full h-[75px]">
          <p className="text-[18px] text-[#616161] ml-8 font-medium">About Us</p>
          <Link to="/dashboard/settings/about" className="mr-8 text-[#616161] px-2 py-1 rounded cursor-pointer">
            <IoIosArrowForward />
          </Link>
        </div>
      </div>
